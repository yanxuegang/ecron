...
//
//	mockgen -source=./types.go -package=preemptmocks -destination=./mocks/preempt.mock.go
//
...
func (mr *MockTaskLeaserMockRecorder) Refresh(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockTaskLeaserMockRecorder) Release(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
